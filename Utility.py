...
"""
Given a list of images, scan for the location of the subimage. Adjusted to allow for tolerance
@:param image as np array
@:param search_images to search for, as list of numpy arrays
...
def scan_for_image(image, search_image):
    ...
    for row in range(im_height):
        for col in range(im_width):
            ...
            # compare it against all of the search images
